                                ...
                                <div className="col-md-6">
                                    <div className="row">
                                        <div className="col-sm-6 col-md-5">
                                            <div className="about-img">
                                                <img src="fotobruno.png" className="img-fluid rounded b-shadow-a" alt="" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="skill-mf">
                                        ...
                                        <div className="progress">
                                            <div className="progress-bar" role="progressbar" style={{width: "85%" ,  arialValuenow="85" , arialValuemin="0" , arialValuemax="100"}}></div>
                                        </div>
                                        <span>CSS</span> <span className="pull-right">85%</span>
                                        <div className="progress">
                                            <div className="progress-bar" role="progressbar" style={{width: "85%" aria-valuenow="85" , aria-valuemin="0" , arialValuemax="100"}}></div>
                                        </div>
